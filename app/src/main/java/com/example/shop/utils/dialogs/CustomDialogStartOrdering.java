...
public class CustomDialogStartOrdering extends Dialog implements View.OnClickListener,
    ...
    public CustomDialogStartOrdering(@NonNull Context mContext) {
        super(mContext);
    ...
    public void onClick(View v) {
        if(mSpinnerCity.getSelectedItemPosition() == 0){
            CustomDialogNotiChooseCity customDialogNotiChooseCity = new CustomDialogNotiChooseCity(mContext);
            ...
            Toast.makeText(mContext, "" + mSpinnerCity.getSelectedItem().toString(), Toast.LENGTH_SHORT).show();
            dismiss();
        }
    }
