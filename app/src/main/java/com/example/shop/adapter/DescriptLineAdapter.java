...
public class DescriptLineAdapter extends RecyclerView.Adapter<DescriptLineAdapter.ViewHolder> {

    ArrayList<ProductALaCarte> mAlacarteArrList;
    Context context;

    public DescriptLineAdapter(ArrayList<ProductALaCarte> mAlacarteArrList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.layout_descript_line, parent, false));
    }
